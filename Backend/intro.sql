...
select distinct (language)continent from word.countryc 
join world.contrylanguage l on c.code = l.countryCode
where continet = 'south america'
order by continet,language;
